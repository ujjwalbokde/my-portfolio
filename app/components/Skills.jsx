...
const Skills = () => {
  return (
    <div className="bg-hero-simple bg-cover bg-no-repeat min-h-screen w-full pt-16 pb-16 element" name="skills">
      <div className="w-full max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center mb-8 sm:mb-16">
          <div className="w-40 sm:w-80 h-2 bg-sky-600"></div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
          {[
            ...
            <div
              key={index}
              className="text-center rounded-lg border border-gray-900 p-4 sm:p-6 flex flex-col justify-center items-center hover:shadow-lg transition-shadow duration-200"
            >
              <img
                src={skill.src}
